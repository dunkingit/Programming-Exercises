...
public class LectureExampleTest {
	...
	public void length_returns_the_number_of_characters_in_a_String() {
		 // FOR DEMONSTRATION PURPOSES ONLY, don't do this in your own tests
		...
		Assert.assertEquals(5, length); // Assert
		System.out.println("length_returns_the_number_of_characters_in_a_String");
	}
