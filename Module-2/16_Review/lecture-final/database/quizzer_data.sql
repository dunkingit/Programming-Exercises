INSERT INTO quiz(title,user_id)VALUES ('quiz 1', (SELECT user_id FROM quiz_user WHERE username = 'rauh'));
INSERT INTO quiz(title,user_id)VALUES ('quiz 2', (SELECT user_id FROM quiz_user WHERE username = 'rauh'));
