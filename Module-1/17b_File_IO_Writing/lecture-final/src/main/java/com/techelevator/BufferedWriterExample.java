...
public class BufferedWriterExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (Scanner inputScanner = new Scanner(file); PrintWriter writer = new PrintWriter(new FileOutputStream(mittensJournal,true)); BufferedWriter bufferedWriter = new BufferedWriter(writer)) {
            int lineNumber = 1;
