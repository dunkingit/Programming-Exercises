...
4. Instantiate an object, or objects, in `main()`/`Main()`, found in the `Module1CodingAssessment` class, and use the objects to test your methods.
...
8. In the main program class, within the main method, populate a list of *Movie Rental* objects. Add up the rental price for all the movies in the list, and print it to the screen.
9. Read in the provided csv file `MovieInput.csv`, and use it to populate the list of *Movie Rental* objects.
