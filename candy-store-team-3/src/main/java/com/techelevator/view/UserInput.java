...
public class UserInput extends Menu{
    ...
    public void fileDoesNotExist(){
        ...
        String choice = input("Do you want to type the filename again or type 'create' to create a file out of random information?");
        if ("create".equalsIgnoreCase(choice)) {
            // Logic to create a file with random information goes here.
        }
    }
